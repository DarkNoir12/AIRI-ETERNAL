...
let __electron_vite_injected_import_meta_url = 'file:///C:/AI_WORKSPACE/airi/apps/stage-tamagotchi/electron.vite.config.ts'
...
let require2 = createRequire(__electron_vite_injected_import_meta_url)
  ...
  renderer: {
    ...
    resolve: {
      ...
      alias: [
        ...
        { find: 'tslib', replacement: require2.resolve('tslib/tslib.es6.js') },
